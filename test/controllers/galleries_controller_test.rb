...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { caption: @gallery.caption, photo: @gallery.photo } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { caption: @gallery.caption, photo: @gallery.photo } }
